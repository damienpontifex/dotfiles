-- Original source https://github.com/MariaSolOs/dotfiles/blob/main/.config/nvim/lua/winbar.lua
local folder_icon = " "
...
vim.api.nvim_create_autocmd("BufWinEnter", {
	group = vim.api.nvim_create_augroup("damienpontifex/winbar", { clear = true }),
	desc = "Attach winbar",
